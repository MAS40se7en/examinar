...
const Create = ({ closeUserGroupForm, users, auth }) => {
                            ...
                            <div>
                                <div className="flex flex-col gap-2 md:flex-row md:items-center md:gap-6 mt-4">
                                    ...
                                    <TextInput
                                        ...
                                        className="border-[#bcbcbc] border dark:border-[#3e3d3f] dark:bg-[#1b1b1b] rounded-xl w-64 h-8"
                                    />
                                </div>
                                <InputError
                                    message={errors.name}
                                    className="mt-2 ml-32 text-nowrap"
                                />
                                <div className="flex flex-col gap-2 md:flex-row md:items-center md:gap-14 mt-4">
                                    <InputLabel
                                        htmlFor=""
                                        value="Users:"
                                        className="text-nowrap w-16 font-bold"
                                    />
                                    <button
                                        onClick={showUsers}
                                        type="button"
                                        className="flex items-center justify-center h-8 w-full lg:w-44 mt-3 md:mt-0 text-nowrap text-white bg-green-500 px-6 rounded-xl font-bold dark:hover:bg-green-700 hover:bg-green-700 focus:outline-none focus:ring-1 transition ease-in-out duration-150"
                                    >
                                        Manage Users
                                    </button>
                                ...
                                <div className="flex lg:ml-44 flex-col gap-2 md:flex-row md:items-center md:gap-14 mt-4"></div>
                            </div>

                            <div className="flex justify-end gap-4 mt-6">
                                <button
                                    type="button"
                                    onClick={closeUserGroupForm}
                                    className="bg-red-500 px-6 py-1 rounded-xl font-bold text-white dark:bg-red-700 dark:hover:bg-red-500 hover:bg-red-700 focus:outline-none focus:ring-1 transition ease-in-out duration-150"
                                >
                                    Cancel
                                </button>
