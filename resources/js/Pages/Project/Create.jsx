...
export default function Create({ auth, users, userGroups }) {
    ...
    const handleUserSelection = (user) => {
        setSelectedUsers((prevSelectedUsers) => {
            const userExists = prevSelectedUsers.find(
    ...
    const handleRemoveUser = (userToRemove) => {
        setSelectedUsers((prevSelectedUsers) =>
            prevSelectedUsers.filter((user) => user.id !== userToRemove.id)
        );
    };
                    ...
                    <div className="sm:rounded-lg flex flex-col items-center w-full ">
                        ...
                        <div className="p-6 text-gray-900 border rounded-3xl  border-gray-300 bg-[#d9d9d9] dark:bg-[#141414] dark:text-white dark:border-[#242424] w-full lg:w-3/4">
                            <form onSubmit={onSubmit}>
                                ...
                                <div className="flex flex-col gap-2 lg:flex-row mt-4 lg:gap-14">
                                    <InputLabel
                                        htmlFor="description"
                                ...
                                <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:gap-14 mt-4">
                                    ...
                                    <TextInput
                                        ...
                                        type="date"
                                        name="start_date"
                                        className="rounded-xl w-full lg:w-72 h-8 dark:bg-[#1b1b1b] border-none focus:outline-none focus:ring-0"
                                ...
                                <div className="flex justify-end gap-4 mt-6">
                                    ...
                                    <button
                                        ...
                                        disabled={processing}
                                        className={`${
                                            processing ? "hover:bg-none" : ""
                                        } text-white bg-green-500 px-6 py-1 rounded-xl font-bold   dark:hover:bg-green-700  hover:bg-green-700 focus:outline-none focus:ring-1  transition ease-in-out duration-150`}
                                    >
                                        Create
                                    </button>
                                </div>
